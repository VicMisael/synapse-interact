...
error_codes = {
    ...
    "M_USER_IN_USE": "register a user ID which has been taken.",
    "M_INVALID_USERNAME": "Encountered when trying to register a user ID which is not valid.",
    "M_ROOM_IN_USE": "the room alias given to the createRoom API is already in use.",
    "M_INVALID_ROOM_STATE": "the initial state given to the createRoom API is invalid.",
    ...
    "M_RESOURCE_LIMIT_EXCEEDED": "The request cannot be completed because the homeserver has reached a resource limit imposed on it. Typically, this error will appear on routes which attempt to modify state and not routes which only read state.",
